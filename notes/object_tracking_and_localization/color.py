...
class Color(object):
    ...
    def __add__(self, other):
        ...
        new_color_red = (self.r + other.r)/2
        new_color_green = (self.g + other.g)/2
        new_color_blue = (self.b + other.b)/2
        
        return Color(new_color_red, new_color_green, new_color_blue)
